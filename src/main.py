...
if __name__ == "__main__":
    ...
    plt.subplot(1, 2, 1)
    plt.plot(quality_arr, mse_arr, color='r', label='MSE')
    plt.plot(quality_arr, psnr_arr, color='b', label='PSNR')

    plt.xlabel('Quality')
    plt.ylabel('Metrics')
    plt.title('Graph of MSE and PSNR vs Quality')
    plt.legend()
    plt.grid(True)
    ...
    plt.xlabel('Quality')
    plt.ylabel('Metrics')
    plt.title('Graph of Metrics vs SSIM')
    plt.legend()
    plt.grid(True)
    plt.show()
